...
export const mapProjectToDb = (p: Project) => ({
  ...
  operation_method: p.operationMethod || null,
  budget_source: p.budgetSource || null,
  budget_category: p.budgetCategory || null,
  national_strategy: p.nationalStrategy || null,
  master_plan: p.masterPlan || null,
  related_plans: p.relatedPlans || null,
  strategic_section2: p.strategicSection2 || null,
  target_group: p.targetGroup || null,
  target_area: p.targetArea || null,
  expected_benefits: p.expectedBenefits || [],
  expense_details: p.expenseDetails || [],
  monthly_budget_plan: p.monthlyBudgetPlan || [],
  attachments: p.attachments || [],
  investment_commitment_q1: p.investmentCommitmentQ1 || 0,
...
export const mapDbToProject = (row: any): Project => ({
  ...
  operationMethod: row.operation_method || undefined,
  budgetSource: row.budget_source || undefined,
  budgetCategory: row.budget_category || undefined,
  nationalStrategy: row.national_strategy || undefined,
  masterPlan: row.master_plan || undefined,
  relatedPlans: row.related_plans || undefined,
  strategicSection2: row.strategic_section2 || undefined,
  ...
  monthlyBudgetPlan: row.monthly_budget_plan || [],
  attachments: row.attachments || [],
  investmentCommitmentQ1: Number(row.investment_commitment_q1) || 0,
